...
client.query(`CREATE TABLE IF NOT EXISTS questions ( question_id int PRIMARY KEY NOT NULL, product_id int NOT NULL, question_body text NOT NULL, question_date bigint NOT NULL, asker_name varchar(40) NOT NULL, asker_email text NOT NULL, reported smallint NOT NULL, question_helpfulness smallint NOT NULL);`)
  .then((confirm) => {
  ...
  .then((confirm) => {
    ...
    client.query(`CREATE TABLE IF NOT EXISTS photos ( photo_id int PRIMARY KEY, answer_id int NOT NULL, url text NOT NULL, CONSTRAINT photos_fk FOREIGN KEY(photo_id) references answers(answer_id));`)
  })
  .then((confirm) => {
